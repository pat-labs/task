...
class BuilderEnv:
    ...
    def load_env() -> Env:
        return Env(
            ...
            error_file_name=os.getenv("ERROR_FILE_NAME", "builder_error_message.json"),
            ...
            filesystem_database_dir=os.getenv("FILESYSTEM_DATABASE_DIR", "tmp"),
